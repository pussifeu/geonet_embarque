...
import geonet.obd.reader.io.ObdCommandJob.ObdCommandJobState;
 ...
 */
/* Pour le test si bluetooth is desable*/
public class MockObdGatewayService extends AbstractGatewayService {
    ...
    public void startService() {
        ...
        //queueJob(new ObdCommandJob(new SelectProtocolCommand(ObdProtocols.SAE_J1939_CAN)));
