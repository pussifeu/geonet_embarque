...
/**
 * Activity pour le menu settings
 */
public class ConfigActivity extends AppCompatPreferenceActivity implements OnPreferenceChangeListener {
    ...
    public static int getObdUpdatePeriod(SharedPreferences prefs) {
        String periodString = prefs.getString(ConfigActivity.OBD_UPDATE_PERIOD_KEY, "1"); // 1 as in seconds
        int period = 1000;
    ...
    public static int getGpsUpdatePeriod(SharedPreferences prefs) {
        String periodString = prefs.getString(ConfigActivity.GPS_UPDATE_PERIOD_KEY, "1"); // 1 as in seconds
    ...
    public static float getGpsDistanceUpdatePeriod(SharedPreferences prefs) {
        String periodString = prefs.getString(ConfigActivity.GPS_DISTANCE_PERIOD_KEY, "5"); // 5 as in meters
